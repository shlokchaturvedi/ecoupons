...
public class Cache implements Cacheable {
     ...
     */
    protected long maxSize = 128 * 1024;
    ...
    public Cache(long maxSize, long maxLifetime) {
        this();
        this.maxSize = maxSize;
        this.maxLifetime = maxLifetime;
    }
    ...
    public Cache(long maxSize, long maxLifetime, String description) {
        this();
        this.maxSize = maxSize;
        this.maxLifetime = maxLifetime;
    ...
    public synchronized void add(Object key, Cacheable object) {
        ...
        if (objectSize == -1)
            objectSize = CacheSizes.cacheSizeOfObject(object);
        ...
        size += objectSize;
        CacheObject cacheObject = new CacheObject(object, key, objectSize, _queue);
    ...
    public synchronized Cacheable get(Object key) {
        ...
        return (Cacheable) cacheObject.get();
    }

    public synchronized void remove(Object key, String str) {
    ...
    private java.lang.ref.ReferenceQueue _queue = new java.lang.ref.ReferenceQueue();
    ...
    public Object[] values() {
        ...
        for (int i = 0; i < cacheObjects.length; i++) {
            values[i] = ((CacheObject) cacheObjects[i]).get();
        }
        return values;
    }
    ...
    private final void deleteExpiredEntries() {
        ...
        while (expireTime > node.timestamp) {
            // Remove the object
            remove(node.object, "Cache deleteExpiredEntries:");
    ...
    private final void cullCache() {
        ...
        if (size >= maxSize * .97) {
            ...
            while (size > desiredSize) {
                ...
                remove(lastAccessedList.getLast().object, "Cache being too big,clean out:");
            }
        }

        CacheObject _o = null;
        while ((_o = (CacheObject) _queue.poll()) != null) {
            remove(_o._key, "");
        }
    ...
    /**
     * General purpose cache  description
     */
