...
public class LongCache implements Cacheable {
     ...
     */
    public LongCache(long maxSize, boolean b) {
        this();
     ...
     *    cache before being deleted.
     */
    public LongCache(long maxSize, long maxLifetime) {
        this();
        this.maxSize = maxSize;
        this.maxObjectSize = (int) (maxSize * .9);
        this.maxLifetime = maxLifetime;
    ...
    public LongCache(long maxSize, long maxLifetime, String description) {
        this();
        this.maxSize = maxSize;
        this.maxLifetime = maxLifetime;
     ...
     * String���?��
     */
    public void add(String key, Cacheable object) {
        add(Long.parseLong(key), object);
    }
