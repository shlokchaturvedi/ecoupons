...
config.Toolbars = [
	["TBHandle", "FontNameMenu", "FontSizeMenu", "FormatBlockMenu", "TBSep", "EditMenu", "FontMenu", "ParagraphMenu", "ComponentMenu", "ObjectMenu", "ToolMenu", "FormMenu", "TableMenu", "FileMenu", "TBSep", "ZoomMenu", "Maximize", "About"]
];
/*config.Toolbars = [
